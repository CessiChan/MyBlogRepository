...
public class BaiDuMapUtil {
    //我的项目key
    private static final String AK = "qeGRoc0LoHzmzRFL1KFGclAZgYkiI5p2";
    private String longitude;
    private String latitude;
    //经纬度转化为中文地址
    public String getPositionByLongitude(String longitude,String latitude) throws Exception {
